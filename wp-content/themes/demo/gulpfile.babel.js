...
//Copy FA4 fonts and styles to dist folder
function fonts(){
    return  gulp.src( PATHS.icons + '/fonts/**/*.{ttf,woff,woff2,eot,svg}')
...
gulp.task('build',
  gulp.series(clean, gulp.parallel(sass, 'webpack:build', images, fonts)));
